...
import { X, Mail, Lock, User, AtSign, MapPin, Star, Users } from 'lucide-react';
...
const benefits = [
  { icon: MapPin, text: 'Save hidden gems to your personal list' },
  { icon: Star, text: 'Rate and review secret local spots' },
  { icon: Users, text: 'Join 12,400+ explorers worldwide' },
];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        await dbServices.signUp(email, password, fullName, username);
      }
      onSuccess();
      onClose();
    } catch (err: any) {
              ...
              <>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      className="w-full border border-gray-200 rounded-xl p-3 pl-10 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all outline-none"
            ...
            {!isLogin && (
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="password"
                    className={`w-full border rounded-xl p-3 pl-10 bg-gray-50 focus:bg-white focus:ring-2 focus:border-transparent transition-all outline-none ${
